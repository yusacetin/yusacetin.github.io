...
const JsInterfaceFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsinterface_free(ptr >>> 0, 1));
...
export class JsInterface {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        JsInterfaceFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsinterface_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.jsinterface_new();
        this.__wbg_ptr = ret >>> 0;
        JsInterfaceFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    draw() {
        wasm.jsinterface_draw(this.__wbg_ptr);
    }
    adjust_window_size() {
        wasm.jsinterface_adjust_window_size(this.__wbg_ptr);
    }
    /**
     * @param {number} dx
     * @param {number} dy
     */
    move_center(dx, dy) {
        wasm.jsinterface_move_center(this.__wbg_ptr, dx, dy);
    }
    /**
     * @param {number} val
     * @param {number} mx

...
export class Canvas {
     ...
     */
    set_points(value) {
        wasm.canvas_set_points(this.__wbg_ptr, value);
    }
    /**
     * @param {number} value
     */
...
export class Shape {
     ...
     */
    set_color(r, g, b) {
        wasm.shape_set_color(this.__wbg_ptr, r, g, b);
    }
    /**
     * @param {number} i
     * @returns {number}
     */
    get_match_index(i) {
        const ret = wasm.shape_get_match_index(this.__wbg_ptr, i);
        return ret >>> 0;
    }
    /**
     * @param {number} i
     ...
     */
    get_point_pos(i) {
        const ret = wasm.shape_get_point_pos(this.__wbg_ptr, i);
     ...
     */
    get_points_vector() {
        const ret = wasm.shape_get_points_vector(this.__wbg_ptr);
     ...
     */
    get_lines_vector() {
        const ret = wasm.shape_get_lines_vector(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('modmul_webgl_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
